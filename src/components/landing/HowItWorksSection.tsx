...
export function HowItWorksSection() {
    return (
        <section className="py-24 bg-gray-50 dark:bg-[#0A192F] relative overflow-hidden transition-colors duration-300">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-20">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4 font-sans"
                    >
                        How It Works
                    </motion.h2>
                    <motion.p
...
function TimelineItem({ step, index }: { step: typeof steps[0]; index: number }) {
    ...
    return (
        <div className={`relative flex items-center ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'} flex-col gap-8`}>
            ...
            <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full border-4 border-gray-50 dark:border-[#0A192F] bg-blue-600 z-10 items-center justify-center shadow-[0_0_20px_rgba(37,99,235,0.5)] transition-colors duration-300">
            ...
            >
                <div className={`
            p-8 rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 backdrop-blur-sm 
        ...
        `}>
                    <div className={`flex items-center gap-4 mb-4 ${isEven ? 'md:flex-row-reverse' : 'flex-row'}`}>
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white font-sans">{step.title}</h3>
                    </div>
